...
folder="/mnt/primevo/work/timothe_dandoy/SLiM_Project/data/Reel_Amboseli_Anubis/BCF_Files/"  # ← à adapter
output_file="/mnt/primevo/work/timothe_dandoy/SLiM_Project/tmp/Reel_Data/Anubis/Nind.txt"
